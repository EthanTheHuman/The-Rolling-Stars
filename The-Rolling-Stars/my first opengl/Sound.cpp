...
const bool Sound::LoadAudio()
{
	...
	//change to Bounce.mp3 for non meme sound
	result = audioMgr->createSound("Sounds/Bounce.mp3", FMOD_DEFAULT, 0, &bounce);
	result = audioMgr->createSound("Sounds/Bounce.wav", FMOD_DEFAULT, 0, &bouncey);
	result = audioMgr->createSound("Sounds/Select.mp3", FMOD_DEFAULT, 0, &select);
